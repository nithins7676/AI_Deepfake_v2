...
- **Pretrained model file**: Download [`vit3class.pth`](https://huggingface.co/nithins7676/vit3class.pth/blob/main/vit3class.pth) and place it in the same directory as `app.py`
